...
#  node01_index   = index(vagrant_vm.Bibind[0].machine_names, "node-01")
#  node02_index = index(vagrant_vm.Bibind[0].machine_names, "node-02")
...
#  node01_user         = vagrant_vm.Bibind[0].ssh_config[local.node01_index].user
#  node01_private_key  = vagrant_vm.Bibind[0].ssh_config[local.node01_index].private_key
#  node01_port         = vagrant_vm.Bibind[0].ssh_config[local.node01_index].port
#  node01_host         = vagrant_vm.Bibind[0].ssh_config[local.node01_index].host
#
#  rancher03_value = [
#    {
#      "name" : "node-01",
